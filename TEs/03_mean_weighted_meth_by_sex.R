...
## -------------------------------------------------------------------------
setwd("~/Dropbox/Research/Leicester_postdoc/Projects/IDLE/Ben_Developmental_BB/TEs/weighted_meth_te")
library(sqldf)
library(readr)
library(doBy)
library(dplyr)
...
write.table(all_data2, file="weighted_meth_annotation_by_stage_TEs.txt", col.names = T,
