...
#my_genes <- read.table("./diff_meth_gene_lists/AvsB_diff_meth_genes_final.txt", header = T)
#my_genes <- read.table("./diff_meth_gene_lists/AvsE_diff_meth_genes_final.txt", header = T)
#my_genes <- read.table("./diff_meth_gene_lists/BvsC_diff_meth_genes_final.txt", header = T)
#my_genes <- read.table("./diff_meth_gene_lists/BvsF_diff_meth_genes_final.txt", header = T)
#my_genes <- read.table("./diff_meth_gene_lists/CvsD_diff_meth_genes_final.txt", header = T)
#my_genes <- read.table("./diff_meth_gene_lists/DvsE_diff_meth_genes_final.txt", header = T)
my_genes <- read.table("./diff_meth_gene_lists/EvsF_diff_meth_genes_final.txt", header = T)
...
#write.table(REVIGO,"./Diff_meth_FDR0.01/AvsB_enriched_GOs.txt",row.names = F,sep = "\t",quote = F)
#write.table(REVIGO,"./Diff_meth_FDR0.01/AvsE_enriched_GOs.txt",row.names = F,sep = "\t",quote = F)
#write.table(REVIGO,"./Diff_meth_FDR0.01/BvsC_enriched_GOs.txt",row.names = F,sep = "\t",quote = F)
#write.table(REVIGO,"./Diff_meth_FDR0.01/BvsF_enriched_GOs.txt",row.names = F,sep = "\t",quote = F)
#write.table(REVIGO,"./Diff_meth_FDR0.01/CvsD_enriched_GOs.txt",row.names = F,sep = "\t",quote = F)
#write.table(REVIGO,"./Diff_meth_FDR0.01/DvsE_enriched_GOs.txt",row.names = F,sep = "\t",quote = F)
write.table(REVIGO,"./Diff_meth_FDR0.01/EvsF_enriched_GOs.txt",row.names = F,sep = "\t",quote = F)
